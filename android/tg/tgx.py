...
LastEditTime: 2024-11-26 17:35:37
...
from lamda.client import Point, GrantType
...
def grant_app(app):
    ...
    try:
        app.grant("android.permission.ACCESS_COARSE_LOCATION", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("android.permission.ACCESS_BACKGROUND_LOCATION", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("android.permission.READ_EXTERNAL_STORAGE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("android.permission.WRITE_EXTERNAL_STORAGE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    ...
    try:
        app.grant("android.permission.MODIFY_AUDIO_SETTINGS", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    ...
    try:
        app.grant("android.permission.FOREGROUND_SERVICE_LOCATION", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("android.permission.FOREGROUND_SERVICE_MEDIA_PLAYBACK", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("android.permission.FOREGROUND_SERVICE_PHONE_CALL", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    ...
    try:
        app.grant("android.permission.RECEIVE_BOOT_COMPLETED", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    ...
    try:
        app.grant("android.permission.REQUEST_INSTALL_PACKAGES", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    ...
    try:
        app.grant("com.google.android.providers.gsf.permission.READ_GSERVICES", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.google.android.c2dm.permission.RECEIVE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("org.thunderdog.challegram.permission.MAPS_RECEIVE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("org.thunderdog.challegram.permission.C2D_MESSAGE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.sec.android.provider.badge.permission.READ", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.sec.android.provider.badge.permission.WRITE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.htc.launcher.permission.READ_SETTINGS", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.htc.launcher.permission.UPDATE_SHORTCUT", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.sonyericsson.home.permission.BROADCAST_BADGE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.sonymobile.home.permission.PROVIDER_INSERT_BADGE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.anddoes.launcher.permission.UPDATE_COUNT", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.majeur.launcher.permission.UPDATE_BADGE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.huawei.android.launcher.permission.CHANGE_BADGE", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.huawei.android.launcher.permission.READ_SETTINGS", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.huawei.android.launcher.permission.WRITE_SETTINGS", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    ...
    try:
        app.grant("com.oppo.launcher.permission.READ_SETTINGS", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    
    try:
        app.grant("com.oppo.launcher.permission.WRITE_SETTINGS", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
    ...
    try:
        app.grant("android.permission.AUTHENTICATE_ACCOUNTS", mode=GrantType.GRANT_ALLOW)
    except Exception:
        pass
...
def get_last_varifycation(img_path: Path):
    ...
    eles = [x for x in ff.info_of_all_instances() if x.visibleBounds.left == 0 and x.visibleBounds.right==720  and x.visibleBounds.bottom - x.visibleBounds.top > 500 and  x.visibleBounds.bottom - x.visibleBounds.top < 1000]
